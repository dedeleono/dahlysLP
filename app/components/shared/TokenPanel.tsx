...
const TokenPanel: FC  = () => {
    ...
    if(wallet?.publicKey && accountStats) {
        return (
            <div className="rounded-lg border-4 border-black bg-neutral/60 backdrop-blur-md p-5 mt-8">
                <div className="text-lg font-Poppins">Your wallet tokens</div>
                <div className="divider mt-1 mb-1 divide-base-content" />
                <div className="flex flex-col flex-grow gap-4">
                    <div className="flex flex-row gap-2">
                        <div className="w-10">
                            <img className='scale-[2.1] pt-1' src="/images/trtn.png" alt="Imagine" />
                        </div>
                        <div className="flex flex-col flex-grow">
                            <div className="flex flex-row gap-4">
                                <div className="text-lg font-damion">
                                    IMGN
                                </div>
                    ...
                    <div className="flex flex-row gap-2">
                        <div className="w-10">
                            <img className="scale-[2.1] pt-1" src="/images/drmrs.png" alt="Dream" />
                        </div>
                        <div className="flex flex-col flex-grow">
                            <div className="flex flex-row gap-4">
                                <div className="text-lg font-damion">
